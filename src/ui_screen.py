...
class Ui_wnd_pyjiff(object):
    def setupUi(self, wnd_pyjiff):
        ...
        self.horizontalLayout_12.addWidget(self.lbl_resize_width)
        self.line_resize_width = QtWidgets.QLineEdit(self.tab_gif)
        self.line_resize_width.setEnabled(False)
        ...
        self.horizontalLayout_12.addWidget(self.lbl_resize_height)
        self.line_resize_height = QtWidgets.QLineEdit(self.tab_gif)
        self.line_resize_height.setEnabled(False)
        self.line_resize_height.setAcceptDrops(True)
        self.line_resize_height.setClearButtonEnabled(False)
